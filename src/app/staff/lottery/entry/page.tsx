  ...
  if (success) {
    return (
      <StaffLayout module="lottery" shopName="RK Shop 1">
        <div className="p-6 text-center animate-fade-in pt-20">
          ...
          <p className="text-text-secondary mt-2">Daily record for 13 May 2026 has been locked.</p>
          <button 
            onClick={() => window.location.reload()}
            className="mt-8 px-6 py-3 bg-primary text-white rounded-xl font-bold shadow-lg shadow-primary/20 cursor-pointer"
          >
            View History
          </button>
        </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className={`p-6 rounded-2xl border-2 transition-all duration-300 ${
          ...
          <p className="text-[10px] text-text-muted mt-2 font-medium">
            Balance = Collection - (Expense + Advance + Prize)
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="bg-surface p-6 rounded-2xl border border-border space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-text-muted uppercase tracking-widest">Daily Collection (₹)</label>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-text-muted uppercase tracking-widest">Customer Prize Money</label>
              <input 
                type="number" 
                placeholder="0" 
