  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-page p-6 text-center">
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={reset}
          className="flex items-center gap-2 px-5 py-3 bg-lottery text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg shadow-lottery/20 hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer"
        >
